...
function StatisticsAllRequest(props: StatisticsProps) {
  return (
...
function StatisticsNewRequest(props: StatisticsProps) {
  return (
    <div className="bg-zinc-700 rounded-xl p-6 flex-1">
      <p>Новых</p>
...
function StatisticsInProgress(props: StatisticsProps) {
  return (
    <div className="bg-zinc-700 rounded-xl p-6 flex-1">
      <p>В работе</p>
...
function StatisticsDone(props: StatisticsProps) {
  return (
    <div className="bg-zinc-700 rounded-xl p-6 flex-1">
      <p>Завершено</p>
